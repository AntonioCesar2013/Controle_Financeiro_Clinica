...
assert.match(body, /Contas compatíveis/);
await workflows.open('recurrence-adjust', 4);
assert.match(body, /data_inicio_vigencia/);
await workflows.open('recurrence-dispense', 4);
assert.match(body, /não cancela nem apaga/);
